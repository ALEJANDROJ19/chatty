...
process_requests(Clients, Servers) ->
    receive
        ...
        {client_leave_req, Name, From} ->
            ...
            broadcast(Servers, {leave, Name}),  %% TODO: COMPLETE ## DONE!
            From ! exit,
            process_requests(NewClients, Servers);  %% TODO: COMPLETE ## DONE!
        {send, Name, Text} ->
            broadcast(Servers, {message, Name, Text}),  %% TODO: COMPLETE ## DONE!
            process_requests(Clients, Servers);
        
        %% Messages between servers
        disconnect ->
            NewServers = lists:delete(self(), Servers),  %% TODO: COMPLETE # DONE!
